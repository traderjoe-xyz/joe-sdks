...
export const LB_ROUTER_V21_ADDRESS: { [chainId in ChainId]: Hex } = {
  ...
  [ChainId.MANTLE]: '0xb4315e873dBcf96Ffd0acd8EA43f689D8c20fB30'
}
...
export const LB_FACTORY_V21_ADDRESS: { [chainId in ChainId]: Hex } = {
  ...
  [ChainId.MANTLE]: '0x8e42f2F4101563bF679975178e880FD87d3eFd4e'
}
...
export const DEXLENS_ADDRESS: { [chainId in ChainId]: Hex } = {
  ...
  [ChainId.MANTLE]: '0x441eF20e39DfE886AAb99a6E1bb64f43E45bD973'
}
